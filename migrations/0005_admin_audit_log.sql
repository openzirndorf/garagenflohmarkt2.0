...
CREATE TABLE admin_audit_log (
  ...
  action     TEXT NOT NULL,  -- CREATED | APPROVED | EDITED | DELETED | REPLIED | REPORTED | REPORT_ACKNOWLEDGED | DEACTIVATED | REACTIVATED | SETTINGS_MANUAL_APPROVAL_ON | SETTINGS_MANUAL_APPROVAL_OFF | SETTINGS_BESCHREIBUNG_ON | SETTINGS_BESCHREIBUNG_OFF
